...
public interface CommonAction {
	...
	//添加订单（日期）
	void addOrderReqInfoDate(CodeT ct, OrderReqInfo reqInfo);
	...
	boolean queryBlackMobile(String mobile);
	...
	OrderT queryOrderTDate(String ffId);
	
	void updateCp(CPInfo info);
	
	void updateOrderInfo(OrderReqInfo info);
	
	void updateOrderInfoDate(OrderReqInfo info);
	...
	//date
	OrderReqInfo queryOrderReqInfoDate(String ffId);
