...
public class CommonTool {
	...
	public static final String FASTSER_BLAMOB = "fastser_blamob_";
...
//				for (int i = 10; i < radio; i++) {
	...
	public static Map<String, String> parseJson(JSONObject jsonobj) {
	...
	public static Map<String, Object> parseJson2(JSONObject jsonobj) {
	...
	public static Map<String, String> parseAll(String content) {
		Map<String, String> params = new HashMap<String, String>();
		try {
			StringTokenizer st = new StringTokenizer(content, "&");
			while (st.hasMoreTokens()) {
				String[] pair = st.nextToken().split("=");
				String key = URLDecoder.decode(pair[0], "UTF-8");
				String value = pair.length == 1 ? "" : URLDecoder.decode(
						pair[1], "UTF-8");
				params.put(key, value);
			}
		} catch (UnsupportedEncodingException e) {
