...
public class HttpUtils {
	 ...
	 * @return 返回HTTP SERVER的处理结果,如果返回null,发送失败
	 */
	public static String sentHttpsPost(String httpUrl, String postBody, String encoding) {
		return sentHttpsPost(httpUrl, postBody, encoding, null);
	}
	 ...
	 * .................
	 */
	public static String sentHttpsPost(String httpUrl, String postBody, String encoding, Map<String, String> headerMap) {
