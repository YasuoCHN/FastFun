...
public class HMacMD5 {
	...
	public static void main(String[] args) {
		String data = "amount=1&app_id=98b41c0791717681&order_id=6490272d-ec9c-44cc-b6a0-d44471653232&order_name=test";
		String key = "77520706dd0e697969b43f5db8c9379f7769157a";
		System.out.println(getHmacMd5Str(key,data));;
	}
}
